    ...
    for each in images:
        ...
        for i in range(params.batch_size):
            util.depth2mesh(basic_depth_[i], mask_batch[i],
                            os.path.join(params.output_dir, index + '_basic_depth'))
            util.depth2mesh(pred_detail_depth_[i], mask_batch[i],
                            os.path.join(params.output_dir, index + '_detail_depth'))
            util.depth2mesh(regressed_depth_[i], mask_batch[i],
                            os.path.join(params.output_dir, index + '_regress_depth'))
